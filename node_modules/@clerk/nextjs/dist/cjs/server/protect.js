...
const isPageRequest = (req) => {
  var _a;
  return req.headers.get(import_internal.constants.Headers.SecFetchDest) === "document" || ((_a = req.headers.get(import_internal.constants.Headers.Accept)) == null ? void 0 : _a.includes("text/html")) || !!req.headers.get(import_constants.constants.Headers.NextUrl) && !isServerActionRequest(req) || !!req.headers.get(import_constants.constants.Headers.NextjsData);
};
