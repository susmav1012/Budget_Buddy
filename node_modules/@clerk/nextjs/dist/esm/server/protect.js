...
const isPageRequest = (req) => {
  var _a;
  return req.headers.get(constants.Headers.SecFetchDest) === "document" || ((_a = req.headers.get(constants.Headers.Accept)) == null ? void 0 : _a.includes("text/html")) || !!req.headers.get(nextConstants.Headers.NextUrl) && !isServerActionRequest(req) || !!req.headers.get(nextConstants.Headers.NextjsData);
};
export {
  createProtect
};
